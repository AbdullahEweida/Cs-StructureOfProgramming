    ...
    class Program
    {
        ...
        */
        static void Main(string[] args)
        {
            ...
            StreamReader reader = new StreamReader("/mnt/data2/Cs-StructureOfProgramming/Cs-lec8/Assignment(1)-Arange the list of names/Original names.txt");
            StreamWriter writer = new StreamWriter("/mnt/data2/Cs-StructureOfProgramming/Cs-lec8/Assignment(1)-Arange the list of names/Sorted names.txt");
            string [] Names = File.ReadAllLines("/mnt/data2/Cs-StructureOfProgramming/Cs-lec8/Assignment(1)-Arange the list of names/Original names.txt");//** to read all a names in the file and store it in an array.
